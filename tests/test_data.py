...
class MyTestCase(unittest.TestCase):
    ...
    def test_to_vector(self):
        ...
        self.assertEqual(data['wcet_flow0_task0'], 5)
        self.assertEqual(data['wcet_flow1_task1'], 10)
        self.assertEqual(data['wcet_flow1_task2'], 10)
        self.assertEqual(data['mapping_proc0_flow0_task0'], 1)
        self.assertEqual(data['mapping_proc1_flow0_task0'], 0)
        self.assertEqual(data['mapping_proc2_flow1_task1'], 1)
        self.assertEqual(data['priority_flow0_task2'], 1)
        self.assertEqual(data['priority_flow1_task1'], 10)
